...
public enum ErrorCode {
    ...
    NICKNAME_NOT_BLANK(HttpStatus.BAD_REQUEST,"닉네임은 필수 항목입니다."),
    AGE_INVALID(HttpStatus.BAD_REQUEST, "나이는 1~120 사이여야 합니다."),
    USER_DELETE_CONFLICT(HttpStatus.CONFLICT,"연결된 데이터가 있어 회원을 삭제할 수 없습니다.");
